...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="questions_poc",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13questions_poc11AppDelegate")
...
SWIFT_CLASS("_TtC13questions_poc12OptionButton")
...
SWIFT_CLASS("_TtC13questions_poc11RadioButton")
...
SWIFT_CLASS("_TtC13questions_poc13SceneDelegate")
...
SWIFT_CLASS("_TtC13questions_poc14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified counterTitle;
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified stackviewContainer;
- (void)viewDidLoad;
